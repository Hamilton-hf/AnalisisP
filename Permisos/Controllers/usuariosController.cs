...
namespace Permisos.Controllers
{
    public class usuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,emal,password,fecha,idRol")] usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,emal,password,fecha,idRol")] usuario usuario)
        {
            if (ModelState.IsValid)
            {
